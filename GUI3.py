...
def start_detection(target_count, target_time):
    ...
    while True:
        ...
        if results.pose_landmarks:
            ...
            # สะโพก
            cv2.line(img, (right_hip_x, right_hip_y), (right_shoulder_x, right_shoulder_y), (0, 150, 255), 3)
            ...
            # เข่า
            cv2.line(img, (right_ankle_x, right_ankle_y), (right_knee_x, right_knee_y), (200, 100, 255), 3)
            ...
            # แสดงผลมุมบนวิดีโอ
            cv2.putText(img, angle_text, (50, 70), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (255, 255, 255), 2, cv2.LINE_AA)
            # แสดงผลจำนวนครั้งของการวิดพื้น
            cv2.putText(img, f'Push-ups: {push_up_count}', (430, 450), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 50, 0), 2, cv2.LINE_AA)
